...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/broad-flower-28a6)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/broad-flower-28a6
```

A live public deployment of this template is available at [https://broad-flower-28a6.templates.workers.dev](https://broad-flower-28a6.templates.workers.dev)
